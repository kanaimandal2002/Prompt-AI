       ...
       // DOM Elements
        ...
        usePromptBtn.addEventListener('click', () => {
            ...
            tabs.forEach(t => t.classList.remove('active'));
            document.querySelector('.tab[data-tab="writer"]').classList.add('active');
            generatorTab.classList.remove('active');
            writerTab.classList.add('active');
            savedTab.classList.remove('active');
        });
        ...
        getHelpBtn.addEventListener('click', () => {
            const storySoFar = storyText.value.trim();
        ...
        function generateContinuation(text, forStory = false) {
            ...
            setTimeout(() => {
                ...
                if (forStory) {
                    ...
                    document.querySelector(`[data-suggestion="${suggestionId}"]`).addEventListener('click', function() {
        ...
        window.addEventListener('DOMContentLoaded', generatePrompt);
